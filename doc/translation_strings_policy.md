...
This document provides guidelines for internationalization of the Aghilbit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `aghilbit_en.ts` remains unchanged.
