Aghilbit Core version 0.9.4 is now available from:

  https://aghilbit.org/bin/0.9.4/
...
this update is incompatible with the Aghilbit system and could lead to consensus
forks.

Aghilbit Core released binaries from https://aghilbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~aghilbit/+archive/ubuntu/aghilbit
- A third-party or self-compiled Aghilbit Core

upgrade to Aghilbit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
