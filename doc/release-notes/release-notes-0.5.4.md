Aghilbit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/aghilbit/files/Aghilbit/aghilbit-0.5.4/
...
http://gitorious.org/aghilbit/aghilbitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Aghilbit-Qt notifications under Growl 1.3.
Increase required age of Aghilbit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxAghilbit properly when installing Aghilbit-Qt over it. (Windows)
