Aghilbit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/aghilbit/files/Aghilbit/aghilbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Aghilbit
...
New/changed settings (command-line or aghilbit.conf file)
--------------------------------------------------------
