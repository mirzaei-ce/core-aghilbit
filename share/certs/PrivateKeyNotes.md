...
unlocked to sign the Aghilbit-Qt.app bundle.
...
allowing somebody to distribute a Aghilbit-Qt.app or aghilbit-qt-setup.exe with a valid
...
that the aghilbit-qt.exe file inside the installer had not been tampered with.
