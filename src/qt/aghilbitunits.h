...
#ifndef AGHILBIT_QT_AGHILBITUNITS_H
#define AGHILBIT_QT_AGHILBITUNITS_H
...
/** Aghilbit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AghilbitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AghilbitUnits(QObject *parent);

    /** Aghilbit units.
      @note Source: https://en.aghilbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MBT,
...
private:
    QList<AghilbitUnits::Unit> unitlist;
};
typedef AghilbitUnits::Unit AghilbitUnit;

#endif // AGHILBIT_QT_AGHILBITUNITS_H
