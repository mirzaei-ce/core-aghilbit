...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/aghilbit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Aghilbit Core"),
     ...
     * override -datadir in the aghilbit.conf file in the default data directory
     * (to be consistent with aghilbitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
