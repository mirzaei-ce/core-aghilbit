...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Aghilbit Core aghilbit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  aghilbit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded aghilbit transaction") + "\n" +
              "  aghilbit-tx [options] -create [commands]   " + _("Create hex-encoded aghilbit transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded aghilbit transaction
