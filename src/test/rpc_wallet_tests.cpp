...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CAghilbitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CAghilbitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CAghilbitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CAghilbitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CAghilbitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CAghilbitAddress(arr[0].get_str()).Get() == demoAddress.Get());
