...
#ifndef AGHILBIT_TEST_SCRIPTNUM10_H
#define AGHILBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Aghilbit Core 0.10.0, for cross-comparison.
 */
public:
